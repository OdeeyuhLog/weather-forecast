"use strict";
(self["webpackChunkweather_forecast"] = self["webpackChunkweather_forecast"] || []).push([["main"],{
...
/* harmony import */ var _contentLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./contentLoader */ "./src/contentLoader.js");
/* harmony import */ var _assets_utility_thermometer_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets/utility/thermometer.svg */ "./src/assets/utility/thermometer.svg");
/* harmony import */ var _assets_utility_sunrise_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./assets/utility/sunrise.svg */ "./src/assets/utility/sunrise.svg");
/* harmony import */ var _assets_utility_sunset_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./assets/utility/sunset.svg */ "./src/assets/utility/sunset.svg");
/* harmony import */ var _assets_utility_raindrop_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./assets/utility/raindrop.svg */ "./src/assets/utility/raindrop.svg");
/* harmony import */ var _assets_utility_wind_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./assets/utility/wind.svg */ "./src/assets/utility/wind.svg");
/* harmony import */ var _assets_utility_umbrella_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./assets/utility/umbrella.svg */ "./src/assets/utility/umbrella.svg");
/* harmony import */ var _assets_utility_pressure_low_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./assets/utility/pressure-low.svg */ "./src/assets/utility/pressure-low.svg");
/* harmony import */ var _assets_utility_pressure_high_svg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./assets/utility/pressure-high.svg */ "./src/assets/utility/pressure-high.svg");
/* harmony import */ var _assets_utility_wind_toy_svg__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./assets/utility/wind-toy.svg */ "./src/assets/utility/wind-toy.svg");
/* harmony import */ var _assets_utility_weather_hurricane_svg__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./assets/utility/weather-hurricane.svg */ "./src/assets/utility/weather-hurricane.svg");
...
function renderHomePage() {
    ...
    link.rel = "icon";
    link.href = _assets_utility_weather_hurricane_svg__WEBPACK_IMPORTED_MODULE_11__;
    document.head.appendChild(link);

    const loadingScreen = document.createElement("div");
    const loadingImg = document.createElement("img");
    loadingScreen.id = "loading-screen";
    loadingImg.src = _assets_utility_wind_toy_svg__WEBPACK_IMPORTED_MODULE_10__;
    ...
    arrowDown.src = _assets_utility_pressure_low_svg__WEBPACK_IMPORTED_MODULE_8__;
    ...
    arrowUp.src = _assets_utility_pressure_high_svg__WEBPACK_IMPORTED_MODULE_9__;
    ...
    const detailCards = [
        { imgSrc: _assets_utility_thermometer_svg__WEBPACK_IMPORTED_MODULE_2__, id: "feels", label: "Feels Like" },
        { imgSrc: _assets_utility_sunrise_svg__WEBPACK_IMPORTED_MODULE_3__, id: "sunrise", label: "Sunrise" },
        { imgSrc: _assets_utility_sunset_svg__WEBPACK_IMPORTED_MODULE_4__, id: "sunset", label: "Sunset" },
        { imgSrc: _assets_utility_raindrop_svg__WEBPACK_IMPORTED_MODULE_5__, id: "humidity", label: "Humidity" },
        { imgSrc: _assets_utility_wind_svg__WEBPACK_IMPORTED_MODULE_6__, id: "wind-speed", label: "Wind Speed" },
        { imgSrc: _assets_utility_umbrella_svg__WEBPACK_IMPORTED_MODULE_7__, id: "rain-chance", label: "Rain Chance" },
    ];
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            currentData = await (0,_weather__WEBPACK_IMPORTED_MODULE_0__.getWeatherData)(currentLocation);
            input.value = "";
            forecastData = await (0,_weather__WEBPACK_IMPORTED_MODULE_0__.getForecastData)(
                currentData.location.lat,
                currentData.location.lon
            );

            if (updateTempBtn.textContent.includes("F")) {
                (0,_contentLoader__WEBPACK_IMPORTED_MODULE_1__.populateSections)(currentData);
                (0,_contentLoader__WEBPACK_IMPORTED_MODULE_1__.populateForecasts)(forecastData);
            } else {
                (0,_contentLoader__WEBPACK_IMPORTED_MODULE_1__.populateSections)(currentData, "F");
                (0,_contentLoader__WEBPACK_IMPORTED_MODULE_1__.populateForecasts)(forecastData, "F");
            }
    ...
    updateTempBtn.addEventListener("click", async () => {
        if (updateTempBtn.textContent.includes("F")) {
            ...
            updateTempBtn.textContent = "Switch to F°";
            (0,_contentLoader__WEBPACK_IMPORTED_MODULE_1__.populateSections)(currentData, "C");
            (0,_contentLoader__WEBPACK_IMPORTED_MODULE_1__.populateForecasts)(forecastData);
        }
    });
...
async function initPageContent() {
    ...
    loadingScreen.classList.remove("fade-out");
    loadingScreen.style.display = "flex";
    currentData = await (0,_weather__WEBPACK_IMPORTED_MODULE_0__.getWeatherData)();
    forecastData = await (0,_weather__WEBPACK_IMPORTED_MODULE_0__.getForecastData)(
        currentData.location.lat,
        currentData.location.lon
    );
...
/* harmony export */   populateSections: () => (/* binding */ populateSections)
/* harmony export */ });
function populateSections(data, unit = "C") {
    setLocation(data);
    setTimeValues(data);
...
function setWeatherStatus(data) {
    ...
    icon.innerHTML = getIcons(data.icon);
}
...
function populateForecasts(data, unit = "C") {
    const rainChance = document.getElementById("rain-chance");
    rainChance.textContent = `${data[0].rainChance}%`;
    ...
    data.forEach((card) => {
        ...
        cardDay.textContent = card.dayName;

        const cardIcon = document.createElement("div");
        cardIcon.innerHTML = getIcons(card.icon);

        const tempValue = document.createElement("p");
        if (unit === "F") {
            tempValue.textContent = `${card.temp.f} F°`;
        } else {
            tempValue.textContent = `${card.temp.c} C°`;
        }

        cardDiv.appendChild(cardDate);
        cardDiv.appendChild(cardDay);
        cardDiv.appendChild(cardIcon);
        cardDiv.appendChild(tempValue);
...
const weatherApp = (0,_app__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
function sortWeatherData(data, location) {
    return {
        ...
        chance: data.pop,
        date: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.dt), "MM/dd/yyyy"),
        currentTime: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.dt), "h:mm a"),
        sunrise: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.sys.sunrise), "h:mm a"),
        sunset: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.sys.sunset), "h:mm a"),
        location: {
...
function sortForecastData(data) {
    ...
    data.daily.time.forEach((day, index) => {
        const dailyObject = {
            date: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(day), "MM/dd"),
            dayName: weekday[(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(day))],
            temp: {
                c:
                    Math.round(
...
/***/ "./src/assets/utility/pressure-high.svg":
/*!**********************************************!*\
  !*** ./src/assets/utility/pressure-high.svg ***!
  \**********************************************/
...
/***/ "./src/assets/utility/pressure-low.svg":
/*!*********************************************!*\
  !*** ./src/assets/utility/pressure-low.svg ***!
  \*********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src/assets/utility/raindrop.svg":
/*!*****************************************!*\
  !*** ./src/assets/utility/raindrop.svg ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "1a4b41e574e032c9fec5.svg";

/***/ }),

/***/ "./src/assets/utility/sunrise.svg":
/*!****************************************!*\
  !*** ./src/assets/utility/sunrise.svg ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src/assets/utility/thermometer.svg":
/*!********************************************!*\
  !*** ./src/assets/utility/thermometer.svg ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "08fc871be54f08b6c0e3.svg";

/***/ }),

/***/ "./src/assets/utility/umbrella.svg":
/*!*****************************************!*\
  !*** ./src/assets/utility/umbrella.svg ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "2c29f38f8eb2d23a97f3.svg";

/***/ }),

/***/ "./src/assets/utility/weather-hurricane.svg":
/*!**************************************************!*\
  !*** ./src/assets/utility/weather-hurricane.svg ***!
  \**************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "6c28f03b6418aea33703.svg";

/***/ }),

/***/ "./src/assets/utility/wind-toy.svg":
/*!*****************************************!*\
  !*** ./src/assets/utility/wind-toy.svg ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "9a86ce94b879c9325958.svg";

/***/ }),

/***/ "./src/assets/utility/wind.svg":
/*!*************************************!*\
  !*** ./src/assets/utility/wind.svg ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "7666ea56edeecb3eff02.svg";
